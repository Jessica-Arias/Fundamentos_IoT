...
// Utilities
app.use(morgan('dev')); //se indica que se va a usar morgan en modo dev (desarrollador)
...
app.use(require('./rutas/alertas.js'));
app.use(require('./rutas/usuario.js'));
app.use(require('./rutas/zona.js'));
app.use(require('./rutas/arenero.js'));
