...
<body>
    ...
    if (isset($_POST["enviar"])) {
        ...
        $f = $_POST["fecha"];
        $n = $_POST["nivel"]; //Se lee nivel, se procesa para capacidad
        $b = $_POST["id_basurero"];
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card shadow-2-strong" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <h3 class="mb-4">Registrar Dato</h3>
                                ...
                                <div class="form-outline mb-3">
                                    <input type="number" name="nivel" class="form-control form-control-lg" />
                                    <label class="form-label" name="nivel">Nivel Medido (Sensor Proximidad)</label>
                                </div>

                                <div class="form-outline mb-3">
                                    <input type="text" name="id_basurero" class="form-control form-control-lg" />
                                    <label class="form-label" name="id_basurero">ID Basurero</label>
                                </div>
