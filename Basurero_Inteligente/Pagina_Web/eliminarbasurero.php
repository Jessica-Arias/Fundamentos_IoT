...
<body>
    ...
    $url_rest_get = "http://localhost:3000/basurero/";
    ...
    if ($_GET) {
        ...
        $url_rest_del = "http://localhost:3000/basurero/$id";
        ...
        header("Location: eliminarbasurero.php");

    }

    ?>

    <form action="eliminarbasurero.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            for ($i = 0; $i <= $tam_get - 1; $i++) {
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo "<a href=\"?id=" . $id_basurero . "\">Borrrar</a>";
                                echo "</td>";
                                echo "</tr>";
