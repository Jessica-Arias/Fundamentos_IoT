...
<body>
    ...
    if (isset($_POST["enviar"])) {
        ...
        $url_rest = "http://localhost:3000/basurero";
        $data = array(
            "altura" => $a,
            "estado" => $e,
            "alerta" => $al,
    ...
    ?>
    <form action="crearbasurero.php" method="post">
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card shadow-2-strong" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <h3 class="mb-4">Registrar Basurero</h3>

                                <div class="form-outline mb-3">
                                    <input type="text" name="altura" class="form-control form-control-lg" />
                                    <label class="form-label" name="altura">Altura</label>
                                </div>

                                <div class="form-outline mb-4">
                                    <div class="input-group mb-0 form-outline flex-fill">
                                        <label class="input-group-text form-label" name="estado">Estado</label>
                                ...
                                <div class="form-outline mb-4">
                                    <div class="input-group mb-0 form-outline flex-fill">
                                        <label class="input-group-text form-label" name="alerta">Alerta</label>
                                        <select class="select form-control-lg form-outline flex-fill mb-0"
                                            name="alerta">
                                            <option selected>Seleccione...</option>
                                            <option value="Sin Alerta">Sin Alerta</option>
                                            <option value="Alerta Amarilla">Alerta Amarilla</option>
